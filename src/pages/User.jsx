      ...
      <main className="fondo-ritual">
        <div className="envoltorio-user">
          <section className="carta-dinamica text-center">
            <p className="text-danger">No hay sesión activa. Por favor inicia sesión.</p>
    ...
    <main className="fondo-ritual">
      <div className="envoltorio-user">
        <section className="carta-dinamica text-center">
          ...
          {/* Nombre y estado */}
          <h4 className="mt-3">{usuarioActivo.nombre}</h4>
          ...
          <ul className="list-group list-group-flush text-start mb-4">
            <li className="list-group-item bg-transparent border-0">
              <strong>Correo:</strong> {usuarioActivo.email}
            </li>
            <li className="list-group-item bg-transparent border-0">
              <strong>Género:</strong> {usuarioActivo.genero}
            </li>
          </ul>
